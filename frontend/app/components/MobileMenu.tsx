  ...
  return (
    <>
      <button
        ...
        className="md:hidden flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-sm border border-stone-200 hover:bg-stone-50 transition-colors"
